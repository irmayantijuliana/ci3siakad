...
define('CI_BOOTSTRAP_REPO',			'https://github.com/irmayantijuliana/ci3siakad');
define('CI_BOOTSTRAP_VERSION',		'Build 20230717');	// will follow semantic version (e.g. v1.x.x) after first stable launch
